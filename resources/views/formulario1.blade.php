...
<head>
    ...
    @vite('resources/css/formulario1.css')
</head>
<body>
    <div class="container">
        <div class="header">
        ...
        <div class="form-container">
            ...
            <div class="form-group">
                ...
                <div class="input-container">
                    <input type="text" id="dono" placeholder="Nome do proprietÃ¡rio">
            ...
            <div class="buttons">
                <button type="button" class="btn-submit" id="meu">
                    <i class="fas fa-save btn-icon"></i> Cadastrar VeÃ­culo
                </button>
            </div>
        </div>
    </div>
    @vite('resources/js/inicial.js')
